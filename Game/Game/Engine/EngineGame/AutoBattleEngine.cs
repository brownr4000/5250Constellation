...
namespace Game.Engine.EngineGame
{
    ...
    public class AutoBattleEngine : AutoBattleEngineBase, IAutoBattleInterface
    {
        ...
        /// <summary>
        /// The Battle method initalizes a new BattleEngine object
        /// </summary>
        ...
        /// <summary>
        /// The CreateCharacterParty method creates a party of Characters for the AutoBattle
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// The DetectInfinateLoop method determines if the Engine is not ending
        /// 
        /// It checks if there have been too many Rounds or too many Turns in a round
        /// </summary>
        /// <returns></returns>
